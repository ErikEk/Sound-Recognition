...
def gen_shard(sess, input_base_dir, image_filenames, output_filename):
    ...
    for filename in image_filenames:
        ...
        if os.stat(path_filename).st_size == 0:
            print('SKIPPING because of st_size=0',filename)
            continue
        try:
...
def main(argv=None):
    ...
    #gen_data2('../../UrbanSound8K/audio','../../UrbanSound8K/metadata/UrbanSound8K.csv','../data/train/melspectrums/mels')
